...
function App() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col font-sans select-none antialiased">
      ...
      {/* Footer */}
      <footer className="w-full py-6 px-4 border-t border-neutral-905/70 bg-neutral-950 flex flex-col sm:flex-row items-center justify-between gap-4 max-w-7xl mx-auto mt-auto">
